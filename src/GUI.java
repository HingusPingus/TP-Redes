...
public class GUI {
    ...
    public static void mostrarImgs(File folder, JFrame frame,String ip,GUIThread hilo){
        ...
        insertarImagenes(folder,frame);
        frame.setVisible(true);
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

    }
    public static void insertarImagenes(File folder,JFrame frame){
        ...
        for (final File fileEntry : folder.listFiles()) {
            ...
            labels=insertarImagen(offsetv,offseth,labels,frame,fileEntry,i);
    ...
    public static ArrayList<JLabel> insertarImagen(int offsetv, int offseth,ArrayList<JLabel> labels,JFrame frame,File fileEntry, int i){
